...
namespace ETechFlow\BackorderEtaDisplay\Observer;
 ...
 * of Backorder ETA Display is published to the eTechFlow private Composer repo. Fires when the
...
{
    private const PACKAGE     = 'etechflow/module-backorder-eta-display';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-backorder-eta-display.json';
    private const CACHE_KEY   = 'etechflow_bed_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Backorder ETA Display';
