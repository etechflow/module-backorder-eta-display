...
class Activated extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        if (!$sessionId) {
            ...
            return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_backorderetadisplay/license/gate');
        }
        ...
        if ($block) {
            $block->setData('license_key', $licenseKey)
                  ...
                  ->setData('error', $error)
                  ->setData('settings_url', $this->getUrl('adminhtml/system_config/edit/section/etechflow_backorderetadisplay'))
                  ->setData('management_url', $this->getUrl('etechflow_backorderetadisplay/license/gate'));
        }
